...
#group IterationControls
   ...
   uniform int Iterations; slider[0,50,200]
   ...
   //DE tweaks - Scale
   uniform float DEscale; slider[0,1,2]
   //DE tweaks - Offset
   uniform float DEoffset; slider[0,0,8]
...
float sq_r, r, r1, dr, theta, phi, r_pow, theta_pow, phi_pow, pow_eff, fac_eff, cth, cph, sph, sth, tmpx, tmpy, tmpz, tmpx2, tmpy2, tmpz2, r_zxy, r_cxy, h;
vec3 c;
int i;
